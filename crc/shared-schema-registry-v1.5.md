...
- supersedes: none
- superseded_by: none
- notes: Core owns the canonical AgentObservation object. Boundary Contracts owns ObservationContract and ObservationConformant. `contract_version` is Boundary Contracts-owned crossing metadata, not a canonical AgentObservation field. No new named envelope object exists, and no second runtime record is introduced. F-1 ContinuationState remains unresolved. F-3 BindingRecord remains unresolved. F-5 Substrate Actuation and Effect Admission remains outside F-2.
