...
### v1.1 Conceptual Architecture Paper, Companion 8 to Constitutional Runtime Computation v5.4
...
```
CRC parent (v5.4):          ORSR governed continuation loop named. Task-state continuity
