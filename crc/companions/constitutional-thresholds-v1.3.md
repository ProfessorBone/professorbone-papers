...
### v1.3 Conceptual Architecture Paper, Companion 5 to Constitutional Runtime Computation v5.5; closure of the threshold-authority and evidence-packet-provenance residues named in Constitutional Baselines v1.2 and Constitutional Coherence v1.3
...
**Recommended reading order:** Constitutional Runtime Computation v5.5; Constitutional Boundary Contracts v1.0; Constitutional Memory v2.1; Constitutional Retrieval v1.2; Constitutional Baselines v1.2; Constitutional Coherence v1.3; Constitutional Thresholds v1.3 (this paper).
