...
### v1.3 Conceptual Architecture Paper, Companion 8 to Constitutional Runtime Computation v5.13
...
- oar_id: OAR-F003
  ...
  effect: Task Ledger Bind outcome references consume the later F-3 BindingRecord reconciliation, but Task Ledger may align obligation accounting to F-5 without completing F-3.
