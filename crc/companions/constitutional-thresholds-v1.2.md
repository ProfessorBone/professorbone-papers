...
### v1.2 Conceptual Architecture Paper, Companion 5 to Constitutional Runtime Computation v5.3; closure of the threshold-authority and evidence-packet-provenance residues named in Constitutional Baselines v1.2 and Constitutional Coherence v1.2
...
**Recommended reading order:** Constitutional Runtime Computation v5.3; Constitutional Boundary Contracts v1.0; Constitutional Memory v2.1; Constitutional Retrieval v1.2; Constitutional Baselines v1.2; Constitutional Coherence v1.2; Constitutional Thresholds v1.0 (this paper).
