...
### v1.3 Conceptual Architecture Paper, Companion 6 to Constitutional Runtime Computation v5.5; substantial advancement of the task-state continuity residue named in v5.4's Open Problems, and formalization of the Standing (STAND) step named but not specified in CTLC's CRA Assembly
...
**Recommended reading order:** Constitutional Runtime Computation v5.5; Constitutional Boundary Contracts v1.1; Constitutional Memory v2.2; Constitutional Retrieval v1.2; Constitutional Baselines v1.2; Constitutional Coherence v1.2; Constitutional Thresholds v1.2; Constitutional Standing v1.3 (this paper).
