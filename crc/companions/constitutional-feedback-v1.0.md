...
### v1.0 Conceptual Architecture Paper, Companion 9 to Constitutional Runtime Computation v5.4
...
```
CRC parent (v5.4):          ORSR architecture. Task-state continuity named as an
                             open problem.
