...
**Publication state:** draft until committed and pushed
...
- current_loci: [Core v5.12](constitutional-runtime-computation-v5.12.md), [Standing v1.6](companions/constitutional-standing-v1.6.md), [Task Ledger v1.2](companions/constitutional-task-ledger-v1.2.md), [CRC-SSR v1.4](shared-schema-registry-v1.4.md)
- dependency_relationships: OAR-F005
- blocked_by: OAR-F005
- blocks: none
- candidate_owner: Core
- current_authority: non-canonical; CRC-SSR remains AMBIGUOUS.
- required_resolution: complete the F-5 prerequisite architecture, then restart F-3.
- closure_conditions: F-5 prerequisite architecture completed, BindingRecord ownership settled, canonical anchor published, CRC-SSR updated where applicable, README updated where applicable, validation passed, publication completed.
- registry_implications: `crc-ssr:binding-record` remains AMBIGUOUS.
- unresolved_questions: exact binding point, admitted mutation reference, effect admission dependency, and write-order relationship.
- notes: non-authoritative wikilinks: [[BindingRecord]]
- history: created in CRC-OAR v1.0 as BLOCKED by OAR-F005.
...
- current_loci: [Core v5.12](constitutional-runtime-computation-v5.12.md), [Standing v1.6](companions/constitutional-standing-v1.6.md), [Task Ledger v1.2](companions/constitutional-task-ledger-v1.2.md), [Tools v1.1](companions/constitutional-tools-v1.1.md), [CRC-SSR v1.4](shared-schema-registry-v1.4.md)
...
- current_authority: ratified as an architectural gap, not yet canonical doctrine.
- required_resolution: define the constitutional sequence from Resolution through actuation, admission, mutation, binding, cycle recording, and continuation.
- closure_conditions: generic apparatus and predicates ratified, owner boundaries settled, Tools specialization aligned, registry entries added where applicable, README updated, validation passed, publication completed.
- registry_implications: potential future CRC-SSR entries for eligible shared load-bearing objects; no registration occurs in CRC-OAR v1.0.
- unresolved_questions: exact object family, admission record shape, mutation record shape, write order, failure topology, and F-3 unblocking boundary.
- history: created in CRC-OAR v1.0 as SPECIFYING after completion of the read-only F-5 architecture analysis.
...
- current_loci: [Core v5.12](constitutional-runtime-computation-v5.12.md), [Tools v1.1](companions/constitutional-tools-v1.1.md)
- dependency_relationships: OAR-F005
- candidate_owner: Core
- current_authority: unresolved candidate object.
- required_resolution: determine whether Core defines ActuationCommand or an equivalent command object, including scope, one-use authority, audit lineage, and relationship to Resolution.
...
- registry_implications: potential future CRC-SSR entry.
- notes: non-authoritative wikilinks: [[ActuationCommand]]
- history: created in CRC-OAR v1.0 as OPEN.
...
- current_loci: [Tools v1.1](companions/constitutional-tools-v1.1.md), [Core v5.12](constitutional-runtime-computation-v5.12.md)
- dependency_relationships: OAR-F005
- candidate_owner: Core
- current_authority: unresolved candidate object. Tools `ToolResultRecord` is a possible specialization.
- required_resolution: define the generic actuation-result surface and determine how Tools specializes it.
...
- dependency_relationships: OAR-F005
- candidate_owner: Core
- current_authority: unresolved generalized predicate. Tools `ToolResultAdmissible` is a possible specialization.
- required_resolution: define the generalized admission predicate and its relationship to tool, memory, ledger, internal-mutation, and external-effect branches.
...
- registry_implications: potential registry treatment only if the finalized predicate is a shared load-bearing surface.
- history: created in CRC-OAR v1.0 as OPEN.
...
- current_loci: [Standing v1.6](companions/constitutional-standing-v1.6.md), [Core v5.12](constitutional-runtime-computation-v5.12.md), [CRC-SSR v1.4](shared-schema-registry-v1.4.md)
- dependency_relationships: OAR-F005
- candidate_owner: Core or the future actuation companion, subject to ratification
- current_authority: unresolved; Standing's existing `state_mutation_ref` does not establish a canonical object.
- required_resolution: determine whether Core or a future actuation companion owns StateMutationRecord or equivalent governed mutation apparatus.
...
- current_loci: [Core v5.12](constitutional-runtime-computation-v5.12.md), [Standing v1.6](companions/constitutional-standing-v1.6.md), [Task Ledger v1.2](companions/constitutional-task-ledger-v1.2.md)
- dependency_relationships: OAR-F005
- current_authority: unresolved architecture issue.
- required_resolution: establish non-circular ordering among Resolution, actuation command, result, admission, mutation, BindingRecord, CycleRecord, Task Ledger, ContinuationState, and AgentObservation.
...
- current_loci: [Tools v1.1](companions/constitutional-tools-v1.1.md), [Core v5.12](constitutional-runtime-computation-v5.12.md), [Task Ledger v1.2](companions/constitutional-task-ledger-v1.2.md)
- dependency_relationships: OAR-F005
- current_authority: unresolved architecture issue.
- required_resolution: define failure, partial completion, unknown result, compensation, rollback, and irreversible-effect treatment.
...
- current_loci: [Core v5.12](constitutional-runtime-computation-v5.12.md), [Tools v1.1](companions/constitutional-tools-v1.1.md), [Task Ledger v1.2](companions/constitutional-task-ledger-v1.2.md)
- dependency_relationships: OAR-F005, OAR-X002
- current_authority: unresolved architecture issue.
- required_resolution: define one-use commands, duplicate detection, fresh retry authority, and unknown-result retry restrictions.
...
- current_loci: [Core v5.12](constitutional-runtime-computation-v5.12.md), [Tools v1.1](companions/constitutional-tools-v1.1.md), [Memory v2.2](companions/constitutional-memory-v2.2.md), [Task Ledger v1.2](companions/constitutional-task-ledger-v1.2.md)
- dependency_relationships: OAR-F005
- current_authority: unresolved architecture issue.
- required_resolution: establish shared constitutional interfaces and typed branches for internal mutation, memory, ledger, tools, communications, financial effects, and external-world actions.
...
- current_loci: [Tools v1.1](companions/constitutional-tools-v1.1.md), [Core v5.12](constitutional-runtime-computation-v5.12.md), [CRC-SSR v1.4](shared-schema-registry-v1.4.md)
- dependency_relationships: OAR-F005, OAR-A001, OAR-A002, OAR-P001
- current_authority: unresolved architecture issue.
- required_resolution: determine how ToolInvocationProposal, ToolResultRecord, and ToolResultAdmissible conform to or specialize generalized Core actuation apparatus.
